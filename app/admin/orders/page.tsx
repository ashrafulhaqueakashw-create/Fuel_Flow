        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4 text-slate-300">
            ...
            <span className="hidden md:flex items-center gap-1.5 text-slate-300">
              ...
              Dhaka Metropole Tanker Dispatch & Fulfillment Grid
            </span>
          </div>
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-orange-50 text-[#9a3412] border border-orange-200">
                    Order Dispatch Terminal
                  </span>
                </div>
                <p className="text-[11px] text-slate-600 font-medium">
                  Review dispatch statuses, assign employees, and track deliveries
                </p>
              </div>
            </Link>
          </div>
